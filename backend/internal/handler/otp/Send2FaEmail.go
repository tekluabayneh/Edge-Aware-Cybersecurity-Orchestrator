...
import "github.com/edge-aware-cyberSecurity/internal/handler/notification"

// make strure for otp style user frindly html code
// make api call using gmail provider and check eror
// return eror if there is if not nill

// OTP email
func Send2FaEmail(to string, otp string) error {
	senderName := "edge-aware"
	senderEmail := "tekluabayneh@gmail.com"
	subject := "Your OTP Code - from edge-aware"
