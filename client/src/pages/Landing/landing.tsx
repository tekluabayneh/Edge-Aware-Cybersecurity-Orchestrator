                            ...
                            >
                                ...
                                >
                                    <a href="/auth">
                                        ...
                                        <button className="bg-white/10 flex items-center cursor-pointer hover:bg-white/20 text-white text-lg px-10 py-7 rounded-xl shadow-2xl shadow-black/30 border-0 group backdrop-blur-md">
