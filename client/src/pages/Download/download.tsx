            ...
            <div className="relative z-10 container mx-auto px-6 py-16 md:py-24 max-w-6xl">
                ...
                `}>
                                    <div className="p-8 md:p-10 flex flex-col items-center text-center relative">
                                        <div className="mb-5 p-2 z-100">
                                            {/* GitHub Release link top-right */}
                                            {btn.githubRelease && (
                                                <a
                                                    className="absolute top-4 right-4 text-blue-500 cursor-pointer underline p-2 mb-5"
                                                    href={btn.githubRelease}
                                                    target="_blank"
