...
const installMethods: InstallMethods = {
  linux: [
    {
      ...
      commands: [
        "wget https://github.com/tekluabayneh/Edge-Aware-Cybersecurity-Orchestrator/releases/download/v2.0.31/agent_2.0.31_amd64.deb",
        "sudo apt install ./agent_2.0.31_amd64.deb",
        "sudo agent"
      ]
    },
    {
      ...
      commands: [
        "curl -sSL https://raw.githubusercontent.com/tekluabayneh/Edge-Aware-Cybersecurity-Orchestrator/v2.0.31/scripts/install.sh | sudo bash",
        "sudo agent"
      ]
    },
    {
      ...
      commands: [
        "curl -sSL https://github.com/tekluabayneh/Edge-Aware-Cybersecurity-Orchestrator/releases/download/v2.0.31/agent_2.0.31_linux_amd64.tar.gz -o agent.tar.gz",
  ...
  macos: [
    ...
    },
    {
      ...
      commands: [
        "curl -sSL https://raw.githubusercontent.com/tekluabayneh/Edge-Aware-Cybersecurity-Orchestrator/v2.0.31/scripts/install-macos.sh | sudo bash",
        "sudo agent"
      ]
    },
    {
      ...
      commands: [
        "curl -sSL https://github.com/tekluabayneh/Edge-Aware-Cybersecurity-Orchestrator/releases/download/v2.0.31/agent_2.0.31_darwin_amd64.tar.gz -o agent.tar.gz",
        "tar -xzf agent.tar.gz",
        "sudo mv agent /usr/local/bin/agent",
        "sudo agent"
      ]
  ...
  windows: [
    {
      ...
      commands: [
        ...
        "https://github.com/tekluabayneh/Edge-Aware-Cybersecurity-Orchestrator/releases/download/v2.0.31/agent_installer_2.0.31_amd64.exe",
        "",
        "# Then run in PowerShell (Admin):",
        "Start-Process -FilePath \".\\agent_installer_2.0.31_amd64.exe\" -Verb RunAs"
      ]
    },
    {
      id: "zip",
